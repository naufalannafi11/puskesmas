    ...
    <div class="bg-white shadow-xl rounded-2xl p-8 space-y-8">
        ...
        <div class="grid md:grid-cols-2 gap-6 border-b pb-6">
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-800">
                    {{ optional($rekamMedi->pasien)->no_rm ?? '-' }}
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-800">
                    {{ optional($rekamMedi->pasien)->name ?? '-' }}
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-800">
                    {{ optional($rekamMedi->dokter)->name ?? '-' }}
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-800">
                    {{ \Carbon\Carbon::parse($rekamMedi->tanggal)->format('d M Y') }}
                </p>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-gray-800 mt-1 whitespace-pre-line">
                    {{ $rekamMedi->rencana_tindak_lanjut ?? '-' }}
                </p>
            </div>
