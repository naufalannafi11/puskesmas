...
<div class="max-w-5xl mx-auto py-8 space-y-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Detail Rekam Medis (Dokter)</h2>
            <p class="text-xs text-gray-400 font-medium uppercase tracking-widest mt-1">Review informasi lengkap kunjungan pasien</p>
        </div>
        ...
        <div class="p-8 border-b border-gray-100">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-800">{{ optional($rekam_medis->pasien)->name ?? 'N/A' }}</p>
                    <p class="text-[10px] text-gray-400 font-medium mt-0.5 uppercase tracking-widest">RM: {{ optional($rekam_medis->pasien)->no_rm ?? '-' }}</p>
                </div>
        ...
        <div class="p-8 border-b border-gray-100 bg-gray-50/30">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-800 leading-tight">{{ $rekam_medis->diagnosis ?? '-' }}</p>
                </div>
                <div>
        ...
        <div class="p-8 border-b border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-10">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed bg-gray-50/50 p-4 rounded-xl border border-gray-100 whitespace-pre-line">
                        {{ $rekam_medis->pemeriksaan ?? 'Tidak ada catatan pemeriksaan fisik.' }}
                    </p>
                </div>
            </div>
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 font-medium whitespace-pre-line">{{ $rekam_medis->tindakan ?? '-' }}</p>
                </div>
            </div>
        </div>
